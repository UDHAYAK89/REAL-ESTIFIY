...
export default function ListingItems({listing}) {
  return (
    <div className="bg-white shadow-md hover:shadow-lg transition-shadow overflow-hidden rounded-lg sm:w-[330px]">
      ...
      <img src={listing.imageUrls[0]} alt="listing cover" className="h-[320px] sm:h-[220px] w-full object-cover hover:scale-105 transition-scale duration-500"/>
      </Link>
      <div className="p-3 flex flex-col gap-2 w-full">
        ...
        <p className="text-slate-500 mt-2 font-semibold">
          ...
          toLocaleString('en-US') : listing. regularPrice.toLocaleString('en-US')}
