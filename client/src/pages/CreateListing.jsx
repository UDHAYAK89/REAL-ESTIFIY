            ...
            <span className='font-normal text-gray-600 ml-2'>
              The first image will be the cover (max 6)
                ...
                <div className="flex gap-4">
                    ...
                    <button onClick={handleImageSubmit}  className="p-3 text-white border border-green-800 rounded bg-green-800 uppercase hover:shadow-lg disabled:opacity-85 " disabled={uploading}>{ uploading ? 'uploading...' : 'upload'}
                    </button>
...
<button 
                    disabled={loadig || uploading} 
                    className="p-3 bg-slate-700 text-white rounded-lg uppercase hover:opacity-95 disabled:opacity-80" 
                    >
                        {loadig ? 'Creating...' : 'Create listing'}
                    </button>
